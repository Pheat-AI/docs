...
4. **Enhance your prompt (optional)** - Click the "Enhance" button to automatically improve your prompt with more detail and creative elements.
...
4. **Write your prompt (optional)** - Add a text description for the video motion or transformation
5. **Generate** - Click the generate button to create your video
