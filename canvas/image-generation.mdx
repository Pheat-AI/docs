...
- **High-quality references** - Use clear, high-resolution reference images for best results
- **Relevant content** - Choose references that relate to your desired output
- **Specific instructions** - Be explicit about which aspects of the reference you want to incorporate
- **Combine multiple references** - You can use multiple reference images to combine different elements
